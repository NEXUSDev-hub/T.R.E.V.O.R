            ...
            val schema = JSONObject()
                ...
                .put("properties", JSONObject()
                    ...
                    .put("mode", JSONObject()
                        .put("type", "string")
                        .put("enum", JSONArray()
                            .put("NORMAL").put("ANALYSE").put("RESEARCH").put("PROJECT").put("RATIO_SHIFTER").put("TERMINAL")))
                ...
                .put("required", JSONArray()
                    .put("kind").put("mode").put("confidence").put("needsFreshInformation").put("needsAdvancedModel").put("actions"))
                .put("additionalProperties", false)
